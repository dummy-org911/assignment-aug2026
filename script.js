...
const operationsList = [
    {
        ...
        fn: (str) => reverseString(str),
    },
    {
        id: "uppercase",
        name: "2. Convert to Uppercase",
        fn: (str) => toUppercase(str),
    },
    {
        id: "palindrome",
        name: "3. Check Palindrome",
        fn: (str) => isPalindrome(str),
    },
    {
        id: "wordCount",
        name: "4. Count Total Words",
        fn: (str) => countWords(str),
    },
    {
        id: "length",
        name: "5. Count Total Characters",
        fn: (str) => countCharacters(str),
    },
    {
        id: "capitalizeWords",
        name: "6. Capitalize Each Word",
        fn: (str) => capitalizeWords(str),
    },
    {
        id: "countVowels",
        name: "7. Count Vowels",
        fn: (str) => countVowels(str),
    },
    {
        id: "removeSpaces",
        name: "8. Remove All Spaces",
        fn: (str) => removeSpaces(str),
    },
    {
        id: "countConsonants",
        name: "9. Count Consonants",
        fn: (str) => countConsonants(str),
    },
    {
        id: "firstLastChar",
        name: "10. Get First and Last Character",
        fn: (str) => getFirstAndLastChar(str),
    },
    {
        id: "lowercase",
        name: "11. Convert to Lowercase",
        fn: (str) => toLowercase(str),
    },
    {
        id: "startsWithCapital",
        name: "12. Starts With Capital Letter",
        fn: (str) => startsWithCapital(str),
    },
    {
        id: "repeatString",
        name: "13. Repeat String (2x)",
        fn: (str) => repeatString(str),
    },
    { id: "swapCase", name: "14. Swap Case", fn: (str) => swapCase(str) },
    {
        id: "removeVowels",
        name: "15. Remove Vowels",
        fn: (str) => removeVowels(str),
    },
];
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const singleResultContainer = document.getElementById(
